...
namespace RandomStrangers {
    ...
    public sealed partial class Group {
        ...
        public string Name;
#if DEV_BUILD_RS
        [ConfigPerm("Permission", null, LevelPermission.Random)]
        public LevelPermission Permission = LevelPermission.Random;
#else
        ...
        public static void LoadAll() {
...
#if DEV_BUILD_RS
                Register(new Group(LevelPermission.Random, int.MaxValue, int.MaxValue, "&4Ran&5dom &6Str&0ang&8ers", '4'));
#else
            ...
            SaveAll(GroupList);
#if DEV_BUILD_RS
            Player.Random.group = RandomRank;
