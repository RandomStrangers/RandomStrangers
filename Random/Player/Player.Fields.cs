...
namespace RandomStrangers {
    ...
    public partial class Player : IDisposable {
        ...
        public Group group;
#if DEV_BUILD_RS
        public LevelPermission hideRank = LevelPermission.Random;
#else
        ...
        public bool IsSuper;
#if DEV_BUILD_RS
        /// <summary> Whether this player is the RandomStrangers AI instance (Not fully implemented here yet, this is just for when 
        /// he finally is.)</summary>
