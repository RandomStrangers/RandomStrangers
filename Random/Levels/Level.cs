...
using RandomStrangers.Levels.IO;
...
namespace RandomStrangers 
{
    ...
    {        
        ...
        public bool CanJoin(Player p) {
            ...
            LevelPermission plRank = skip ? LevelPermission.Random : p.Rank;
#else
...
#if DEV_BUILD_RS
                    Logger.Log(LogType.RandomMessage, ".properties file for level {0} was not found.", lvl.MapName);
#else
