...
#if DEV_BUILD_RS
        // Want Random to be at top of list, banned to be bottom of list.
        const LevelPermission offset = LevelPermission.Random;
#else
        // Want Console to be at top of list, banned to be bottom of list.
