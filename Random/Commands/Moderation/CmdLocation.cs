...
#if DEV_BUILD_RS
            get { return new[] { new CommandPerm(LevelPermission.Random, "can see state/province") }; }
#else
            get { return new[] { new CommandPerm(LevelPermission.Console, "can see state/province") }; }
#endif
        }
