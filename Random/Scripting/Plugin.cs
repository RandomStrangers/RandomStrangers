...
using RandomStrangers.Core;
using RandomStrangers.Modules.Moderation.Notes;
using RandomStrangers.Modules.Relay.Discord;
using RandomStrangers.Modules.Relay.IRC;
using RandomStrangers.Modules.Relay1.Discord1;
using RandomStrangers.Modules.Relay1.IRC1;
using RandomStrangers.Modules.Relay2.Discord2;
using RandomStrangers.Modules.Relay2.IRC2;
using RandomStrangers.Modules.GlobalRelay.GlobalDiscord;
using RandomStrangers.Modules.GlobalRelay.GlobalIRC;
using RandomStrangers.Modules.Security;
using RandomStrangers.Scripting;

namespace RandomStrangers 
{
    /// <summary> This class provides for more advanced modification to RandomStrangers </summary>
    public abstract class Plugin 
    {
        ...
        public static bool Load(Plugin p, bool auto) {
            try {
                string ver = p.RandomStrangers_Version;
