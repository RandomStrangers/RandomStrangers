...
namespace RandomStrangers.Scripting 
{
...
\t{{
\t\tpublic override string name {{ get {{ return ""{0}""; }} }}
\t\tpublic override string RandomStrangers_Version {{ get {{ return ""{2}""; }} }}
...
\t\t\tEnd Get
\t\t End Property
\t\tPublic Overrides ReadOnly Property RandomStrangers_Version() As String
\t\t\tGet
\t\t\t\tReturn ""{2}""
\t\t\tEnd Get
\t\t End Property
