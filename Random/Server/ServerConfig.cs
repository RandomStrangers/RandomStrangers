...
namespace RandomStrangers {
    public sealed class ServerConfig : EnvConfig {
        ...
        [ConfigString("server-name", "Server", "[RandomStrangers] Default", false, " !\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~")]
        public string Name = "[RandomStrangers] Default";
        ...
        [ConfigString("main-name", "Level", "randomstrangers", false, "()._+,-")]
...
#if DEV_BUILD_RS
        [ConfigString("Core-State", "Chat", "&4Ran&5dom &6Str&0ang&8ers")]
        public string CoreState = "&4Ran&5dom &6Str&0ang&8ers";
#else
