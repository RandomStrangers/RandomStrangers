RandomStrangers is a fully featured and customizable **ClassiCube Server Software** based on [SuperNova](https://github.com/RandomStrangers/SuperNova), which is based on MCGalaxy 1.9.3.9.
