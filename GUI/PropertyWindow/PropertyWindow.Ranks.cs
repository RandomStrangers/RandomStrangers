...
namespace RandomStrangers.Gui {
    ...
    public partial class PropertyWindow : Form {
...
#if DEV_BUILD_RS
            Server.Config.OSPerbuildDefault = GuiPerms.GetPermission(rank_cmbOsMap, LevelPermission.Random);
#else
        ...
        void rank_btnAdd_Click(object sender, EventArgs e) {
            ...
            int perm = 5;
#if DEV_BUILD_RS
            for (int i = (int)LevelPermission.Guest; i <= (int)LevelPermission.Random; i++) {
#else
